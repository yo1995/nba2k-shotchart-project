...
jordan_plot_path = cwd + '/Resources/playoff-plot.html'
...
title_text = 'Shots by Michael Jordan in NBA2K11 MyPlayer mode - Playoff <br>' + str(sum_text)
layout = go.Layout(
    images=[dict(
